...
export default function KitchenScene({ mode }: Props) {
  ...
  useFrame((_, delta) => {
    ...
    if (leftDoor.current && rightDoor.current) {
      ...
      const rightNext = damp(
        rightDoor.current.rotation.y,
        rightTarget,
        animationDelta,
      );
      moving ||=
        Math.abs(leftNext - leftTarget) > 0.001 ||
        Math.abs(rightNext - rightTarget) > 0.001;
  ...
  return (
    <>
      ...
      <group position={[0, -0.35, 0]} rotation={[0, -0.22, 0]}>
        ...
        <mesh
          position={[0, 1.35, 0.53]}
          scale={[3.58, 2.45, 0.09]}
          material={materials.core}
        >
          <boxGeometry />
        </mesh>
        <mesh
          position={[0, 1.35, 0.59]}
          scale={[3.36, 2.24, 0.025]}
        ...
        <group ref={leftDoor} position={[-1.79, 1.72, -0.63]}>
          <mesh
            position={[0.88, 0, 0]}
            scale={[1.68, 1.7, 0.08]}
        ...
        <group ref={rightDoor} position={[1.79, 1.72, -0.63]}>
          <mesh
            position={[-0.88, 0, 0]}
            scale={[1.68, 1.7, 0.08]}
            material={materials.dark}
